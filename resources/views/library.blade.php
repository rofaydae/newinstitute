    ...
    <body>
        <main>
            ...
            <section>
                ...
                <div class="fixed-bg" style="background-image: url({{asset('images/resources/libraryslide.jpg')}});"></div>
                    <div class="container">
                    ...
                    <div class="container">
                        <div class="shop-wrap w-100">
                            ...
                            @foreach($libraries as $library)
                                <div dir="rtl" class="col-md-4 col-sm-6 col-lg-3 flex-row-reverse">
                                    <div class="shop-box w-100">
                                        <div class="shop-img w-100 position-relative overflow-hidden text-center flex-row-reverse">
                                            <img class="img-fluid w-100" src="{{Voyager::image($library->image)}}" alt="">
                                            <a href="" downloadUrl="/Lib/maratib.pdf">قراءة وتحميل</a>
                                        </div>
