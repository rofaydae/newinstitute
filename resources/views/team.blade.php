        ...
        <main>
            ...
            <section>
                <div class="w-100 pt-100 pb-55 position-relative">
                        ...
                        <ul class="team-wrap d-flex flex-wrap justify-content-center w-100 list-unstyled mb-0">   
                            <li class="team-box text-center mb-45 w-100">
                                <div class="team-img rounded-circle position-relative overflow-hidden">
                                    <img class="rounded-circle img-fluid" src="{{asset('images/resources/team-img1-sheikh.jpg')}}" alt="Team Image 10">
                                ...
                                <div class="team-info w-100">
                                    <h3 class="mb-0">الشيخ عبد الغني العمري الحسني</h3>
                    ...
                    <div class="container">
                        <ul class="team-wrap d-flex flex-wrap justify-content-center w-100 list-unstyled mb-0 flex-row-reverse">
                            @foreach($team as $member)
                            <li class="team-box text-center mb-45 w-100">
                                <div class="team-img rounded-circle position-relative overflow-hidden">
                                    <img class="rounded-circle img-fluid" src="{{Voyager::image($member->picture)}}" alt="Team Image 10">
                                    <div class="team-social position-absolute">
                                        <a class="rounded-circle" href="mailto:{{$member->email}}" title="Mail" target="_blank"><i class="fas fa-envelope"></i></a>
                                    </div>
                                </div>
                                <div class="team-info w-100">
