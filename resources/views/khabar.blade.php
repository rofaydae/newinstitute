                                ...
                                <aside class="sidebar-wrap w-100">
                                        <div class="widget2 brd-rd5 w-100">
                                            <div class="about-widget text-center w-100">
                                                <div class="about-widget-img d-inline-block">
                                                    <a class="thm-bg rounded-circle" href="" title=""><i class="fa fa-envelope"></i></a>
                                                    <img class="img-fluid rounded-circle" src="{{asset('images/resources/about-widget-img.jpg')}}" alt="About Image">
                                                </div>
                                                <h4 class="mb-0">{{$khabar->author}}</h4>
                                                <p class="mb-0">{{$khabar->author_bio}}</p>
                                            </div>
                                        </div>
                                        <div class="widget2 blog_widget brd-rd5 w-100 text-right">
                                            <h3>: آخر الأخبار</h3>
                                            <div class="blog-widget-post-list w-100">
                                            @php
                                                use App\Models\Akhbar;
                                            @endphp
                                            @foreach (Akhbar::take(4)->get() as $khabar)
                                                <div class="blog-mini-post w-100">
                                                    <a href="/khabar" title=""><img class="img-fluid" src="{{Voyager::image($khabar->image)}}" alt="Blog Mini Post Icons 1"></a>
                                                    <div class="blog-mini-post-info">
                                                        <h4 class="mb-0"><a href="/khabar" title="">{{$khabar->title}}</a></h4>
                                                        <span class="d-block mini-post-date">{{$khabar->created_at}}</span>
                                                    </div>
                                                </div>
                                            @endforeach
                                            </div>
                                        ...
                                        <div class="widget2 p-0 video-widget brd-rd5 w-100">
                                            <div class="widget-video-box w-100 position-relative">
                                                <img class="img-fluid w-100" src="{{asset('images/resources/widget_img.jpg')}}" alt="Widget Video Image">
                                            </div>
                                        </div>
                                    </aside><!-- Sidebar Wrap -->
                                </div>
