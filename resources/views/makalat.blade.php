        ...
        <main>
            ...
            <section>
                <div class="w-100 pt-170 pb-150 dark-layer3 opc7 position-relative text-right">
                    <div class="fixed-bg" style="background-image: url({{asset('images/resources/articles_slide.jpg')}});"></div>
                    <div class="container">
                                ...
                                <div class="col-md-6 col-sm-6 col-lg-4">
                                    <div class="post-box w-100 text-center">
                                        ...
                                        <div class="post-info w-100">
                                            <h3 class="mb-4"><a href="/makal/{{$article->id}}" title="">{{$article->title}}</a></h3>
