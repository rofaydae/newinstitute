...
<html lang="en">
    ...
    <head>
        ...
        <title>project - Al Omariya Institute</title>
        ...
        <main>
            ...
            <section>
                <div class="w-100 pt-100 pb-100 position-relative">
                    <div class="container">
                        <blockquote>
                            <h2 class="mb-4 text-center" >{{$project->title}}</h2><br>
                            <p dir="rtl" class="mb-0 text-right">{!! html_entity_decode($project->description_text) !!}</p></blockquote>
                    </div>
                </div>
            </section>
