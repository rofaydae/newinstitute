...
<html lang="en">
    ...
    <head>
        ...
        <title>projects - Al Omariya Institute</title>
        ...
        <main>
            ...
            <section>
                <div class="w-100 pt-170 pb-150 dark-layer3 opc7 position-relative text-right">
                    <div class="fixed-bg" style="background-image: url({{asset('images/resources/projects_slide.jpg')}});"></div>
                    <div class="container">
                        <div class="page-top-wrap w-100 ">
                        <h1 class="mb-0">الاختصاصات</h1>
                        </div><!-- Page Top Wrap -->
                    </div>
                </div>
            </section>
                ...
                <div class="w-100 pt-100 pb-100 position-relative">
                    <div class="container text-right">
                        ...
                        <!-- <div class="view-all mt-20 w-100 text-center">
                            <a class="thm-btn thm-bg" href="projects.html" title=""><i class="flaticon-arrow-pointing-to-left"></i>&nbsp;&nbsp;جميع الاختصاصات</a>
                        </div> -->
                    </div>
                </div>
            </section>
